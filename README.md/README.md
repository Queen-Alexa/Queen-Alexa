...
<br/> <div align="center">
[![Fork](https://telegra.ph/file/0cf5e3964afe499d19a2b.png)](https://github.com/Queen-Alexa/hpi-mankind/fork) • [![Telegram Group](https://telegra.ph/file/6ebc3fca0426110f74aa8.png)](https://t.me/BharatTorrentPro)
</div>
...
1. Run the following commands. (Following commands can be used to setup the vps from scratch)
    ...
    1. `git clone https://github.com/Queen-Alexa/Queen-Alexa.git`
    2. `sudo apt update`
